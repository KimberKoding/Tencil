...
public class register extends AppCompatActivity {
    ...
    private String data;
    private static String secretKey = "a61caa1f9aa6005111c14faa323411b0";
    private static String dataSend = "a6lNFeTgMKth2xYKnlIC0o8cO8lubqcE";
    ...
    public static String encrypt(String strToEncrypt) {
        try {
            ...
            return Base64.getEncoder().encodeToString(cipher.doFinal(strToEncrypt.getBytes("UTF-8"))) + "INITVECTOR" + iv.toString();
        } catch (Exception e) {
