...
public class GetAllBusinessesByCidAdapter
        extends RecyclerView.Adapter<GetAllBusinessesByCidAdapter.MyHolder> {
    ...
    public GetAllBusinessesByCidAdapter
            (@Nullable Context mContext,
             @Nullable List<Businesses> allData) {
    ...
    @NonNull
    @Override
    public GetAllBusinessesByCidAdapter.MyHolder
    onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        mContext = parent.getContext ();
        View v = LayoutInflater.from ( mContext ).inflate
                ( R.layout.categoriesallbusinesses, parent, false );
    ...
    public void onBindViewHolder
            (@NonNull GetAllBusinessesByCidAdapter.MyHolder holder,
             int position) {
        assert allData != null;
        Businesses temp = allData.get ( position );
        Random rnd = new Random ();
        int currentColour = Color.argb ( 255, rnd.nextInt ( 256 ),
